...
[CustomEditor(typeof(MegaFlowParticleLegacyMoving))]
public class MegaFlowParticleLegacyMovingEditor : Editor
{
	...
	{
		MegaFlowParticleLegacyMoving mod = (MegaFlowParticleLegacyMoving)target;
